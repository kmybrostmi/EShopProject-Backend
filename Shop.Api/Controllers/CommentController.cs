...
namespace Shop.Api.Controllers
{
    public class CommentController : ApiController
    {
        ...
        [HttpGet]
        public async Task<ApiResult<CommentFilterResult>> GetCommentByFilter([FromQuery]CommentFilterParams commentFilter)
        {
            var result = await _commentFacade.GetCommentByFilter(commentFilter);
            return QueryResult(result);
        }
