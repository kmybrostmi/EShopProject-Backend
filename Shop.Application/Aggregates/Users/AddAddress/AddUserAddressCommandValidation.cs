...
namespace Shop.Application.Aggregates.Users.AddAddress;

public class AddUserAddressCommandValidation:AbstractValidator<AddUserAddressCommand>
{
	public AddUserAddressCommandValidation()
	{
        RuleFor(f => f.City)
